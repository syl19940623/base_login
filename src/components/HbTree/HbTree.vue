...
<script>
  import '@/assets/ztree/jquery-1.4.4.min';
  import "@/assets/ztree/jquery.ztree.all.min.js";
  import "@/assets/ztree/jquery.ztree.exhide.min.js";
  import fuzzySearch from "@/assets/ztree/fuzzysearch.js";
...
<style lang="less">
  ...
  .hbTree{padding: 15px;
    .el-input{margin-bottom: 12px;position: sticky;top: 0;z-index: 999;}
    .ztree{padding: 0;
